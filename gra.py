...
class Pytania:
    def __init__(self):
        ...
        #### Baza wypowiedzi prowadzącego
		self.hubert_correct = ["Mam złą wiadomość. Będziesz się musiał jeszcze trochę pomęczyć. To dobra odpowiedź!",
		 "Nie lubię pożegnań. Na szczęście teraz żadnego nie będzie. Poprawna odpowiedź!",
         "Ta odpowiedź nie jest... niepoprawna. Grasz dalej!",
         "Jeśli miałeś złe przeczucia, to mam złe przeczucie, że były błędne. Dobra odpowiedź!", 
         "Fajnie się grało, ale trzeba będzie pograć jeszcze trochę. To dobra odpowiedź!", 
         "Jedni do domu wracają limuzyną, inni PKS-em. Ty masz szansę być wśród tych drugich. To dobra odpowiedź!", 
         "Szczerość bywa źle odbierana i tym razem tak nie będzie, bo szczerze, to poprawna odpowiedź!",
		...
		self.hubert_incorrect = ["Wszystko co dobre kiedyś się kończy. To zła odpowiedź", "Niestety, niepoprawna odpowiedź",
         ...
         "Zła odpowiedź", "Gra dla ciebie się kończy. Zła odpowiedź"]   
		self.definitywnie = ["Definitywnie?", "Ostatecznie?", "Na pewno?", "To twoja ostateczna odpowiedź?", "Zaznaczamy tę odpowiedź?", "To twoja definitywna odpowiedź?"]
